        ...
        <div className="p-6 border-b border-slate-200 dark:border-slate-700">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex gap-2">
              ...
              <Link
                className="gap-2 cursor-pointer flex items-center justify-center px-4 py-2 border border-slate-300 dark:border-slate-600 rounded-lg bg-white dark:bg-slate-800 text-slate-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                href={"/admin/audit/print"}
              >
                <TbPrinter className="opacity-50"></TbPrinter>
                Print View
              </Link>
            </div>
