      ...
      <form action={action} className="flex flex-col gap-4">
        ...
        <div className="w-full flex gap-2 justify-end pt-2">
          ...
          <button
            disabled={pending}
            type="submit"
            className="dark:border-brand-green-400 hover:bg-brand-blue-600 dark:hover:bg-brand-green-500 dark:bg-brand-green-600 bg-brand-blue-500 border-brand-blue-700 text-white   dark:text-white px-3 py-2 rounded-lg border flex items-center gap-2 transition-all duration-200"
          >
